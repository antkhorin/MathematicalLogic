...
public class Deduction {
    private static ArrayList<AbstractExpression> expressions;
    private static ArrayList<String> strings;
    private static AbstractExpression axioms[] = null;
    private static ArrayList<String> assumptions;
    private static String alpha;
    private static Map<String, String> map = new HashMap<>();


    public static void deduction(String... args) throws IOException {
        if (axioms == null) {
            axioms = new AbstractExpression[11];
            readAxioms();
        }
        ...
        while ((s = in.readLine()) != null) {
            ...
            a = axiomCheck(expressions.get(i));
            if (a == 0) {
                a = assumptionCheck(i);
            }
            if (a != 0) {
